...
Ok lets tweak that. For the source tile, lets change this preview. Now it only scales up a little. Instead lets add the white border. For the target tile, keep it as is
